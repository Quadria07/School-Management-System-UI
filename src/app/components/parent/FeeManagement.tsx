  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card
          className={`bg-gradient-to-br ${totalOutstanding > 0
              ...
              <CardContent>
                <div className="space-y-3">
                  {payments.map((payment) => (
                    <div
                      key={payment.id}
                      className={`p-4 rounded-lg border bg-white transition-shadow ${payment.status === 'pending' ? 'border-amber-200 bg-amber-50/50' : 'border-gray-200 hover:shadow-md'
                        }`}
                    >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <RadioGroup value={selectedPaymentMethod} onValueChange={setSelectedPaymentMethod}>
                <div className="space-y-3">
                  <div
                    className={`flex items-center space-x-3 p-4 rounded-lg border-2 cursor-pointer ${selectedPaymentMethod === 'card'
          ...
          <div className="p-6 md:p-8 overflow-y-auto flex-1" id="school-receipt">
            ...
            <div className="mb-8">
              ...
              <div className="mt-4 flex justify-end">
                <div className={`border-2 font-bold px-4 py-1 rounded uppercase text-sm transform -rotate-2 ${selectedReceipt?.status === 'pending'
